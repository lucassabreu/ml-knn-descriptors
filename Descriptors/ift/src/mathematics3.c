...
Scene *Or3(Scene *scn1, Scene *scn2)
{
  ...
  _or = CreateScene(scn1->xsize, scn1->ysize, scn1->zsize);
  n = scn1->xsize * scn1->ysize * scn1->zsize;
  for (p = 0; p < n; p++)
    _or->data[p] = MAX(scn1->data[p],scn2->data[p]);
...
Scene *And3(Scene *scn1, Scene *scn2)
{
  ...
  _and = CreateScene(scn1->xsize, scn1->ysize, scn1->zsize);
  n = scn1->xsize * scn1->ysize * scn1->zsize;
  for (p = 0; p < n; p++)
    _and->data[p] = MIN(scn1->data[p],scn2->data[p]);
...
Scene *XOr3(Scene *scn1, Scene *scn2){
  ...
  _xor = CreateScene(scn1->xsize, scn1->ysize, scn1->zsize);
  n = scn1->xsize * scn1->ysize * scn1->zsize;
  for (p = 0; p < n; p++)
    _xor->data[p] = MAX(scn1->data[p],scn2->data[p])-
