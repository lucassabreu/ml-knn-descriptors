...
// SceneClusterforMajorityVote returns three maps: label, empty, empty
Scene **ClassifyBayesforMajorityVote( Subgraph *sg, Features3 *f, Scene *mask );
// SceneClusterforMajorityVote returns three maps: label, 1 / spatial distance to the root, density / feature distance to the root
