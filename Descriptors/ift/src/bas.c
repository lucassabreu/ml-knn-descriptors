...
representation_type *extract_feature(boundary_type *boun)
{
...
long min(long Dist1, long Dist2, long Dist3)
{
...
long Cum_Dist_Optimal(representation_type fv1, representation_type fv2, int dim1, int dim2, long *DISTANCE)
{
  long temp_dist;
  int i,j;
  int penalty;
